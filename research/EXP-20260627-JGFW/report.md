...
## 1. Abstract
This scientific report documents the behavior, survival, and dynamics of the Project Genesis agent populations under a controlled experiment setup. In this run (`EXP-20260627-JGFW`), we simulated 3 independent populations across unique topographic seeds. The population evolved under a scarcity setting of 1.0 and completed a runtime of 1000 ticks.
...
The average lifespan across all seeds was **746.1** ticks (approx. 2.1 years). The average number of surviving agents at tick 1000 was **4.0** founders/descendants per seed.

| Seed | Ticks Completed | Survivors | Avg Lifespan (Ticks) | Max Lifespan (Ticks) | Trust Centralization |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1010 | 1000 | 5/16 | 779.9 | 1000 | 0.0 |
| 1020 | 1000 | 5/19 | 737.4 | 1000 | 0.0 |
| 1030 | 1000 | 2/18 | 721.1 | 1000 | 0.0 |
...
*   **Tick 300** | *Emergence: Permanent Settlement*: Agent 1 established a durable permanent shelter (Level 2)
...
*   **Tick 900** | *Anomaly*: Population crash detected: dropped 57.1% (from 7 to 3)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Gen 0 | 16 | 0.464 | 0.47 | 0.378 | 0.519 |
